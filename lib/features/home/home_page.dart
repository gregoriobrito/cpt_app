              ...
              child: Column(
                ...
                children: [
                  ...
                  */
                  ...
                  _buildMenuCard(0, "Nova Partida", "Iniciar jogo agora", Icons.sports_volleyball_rounded, const Color(0xFF00B0FF), () => Navigator.push(context, MaterialPageRoute(builder: (_) => PartidaUsuarioPage(codigoRacha: widget.racha.codigo,)))),
                  _buildMenuCard(1, "Histórico de Partidas", "Gerencie suas partidas", Icons.groups_rounded, const Color(0xFF2979FF), () => Navigator.push(context, MaterialPageRoute(builder: (_) => PartidaHistoricoPage(racha: widget.racha)))),
                  _buildMenuCard(2, "Gerenciar Integrantes", "Partipantes do grupo", Icons.groups_rounded, const Color(0xFF2979FF), () => Navigator.push(context, MaterialPageRoute(builder: (_) => UsuarioListaPage(codigoRacha: widget.racha.codigo)))),
                  _buildMenuCard(3, "Estatísticas", "Desempenho do grupo", Icons.bar_chart_rounded, const Color(0xFFFF6D00), () => _abrirBottomSheet(context, widget.racha.codigo)),
